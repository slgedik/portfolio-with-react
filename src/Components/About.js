...
export default function About() {
    ...
    <div id="about" className="about justify-center items-center"  style={{
      ...
      <h2 className='py-8 underline decoration-wavy italic font-semibold decoration-rose-800'>About Me</h2>
    ...
    <h2 className='mt-16 underline decoration-wavy italic font-semibold decoration-rose-800'>Technologies I am Interested in</h2>
